 ...
 *
 * @typedef {object} CreateUsuarioResult
 * @property {number} id
 * @property {string | null} [passwordGenerada]
 *
 ...
 * @property {string | null} observaciones
 * @property {boolean} tieneFirmaEntrega
 * @property {string | null} fechaFirmaEntrega
 * @property {boolean} tieneFirmaRecibe
 * @property {string | null} documentoPdfUrl
 * @property {string | null} documentoPdfGenerardoEn
 *
