...
export function Modal({ isOpen, onClose, title, footer, children, wide = false }) {
  const titleId = useId();
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        tabIndex={-1}
        className={[
          'relative z-10 flex max-h-[90vh] w-full flex-col rounded-lg bg-white shadow-lg outline-none',
