...
export function EstadosPage() {
  return (
    <NamedCatalogPage
      title="Estados"
      description="Catálogo global del diagrama (sin empresa). Los estados operativos del activo (disponible, asignado, mantenimiento, baja) se calculan por movimientos."
