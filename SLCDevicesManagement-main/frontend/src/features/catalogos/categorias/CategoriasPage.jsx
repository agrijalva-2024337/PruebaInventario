...
import { canWriteEmpresa } from '@/features/auth/permissions';
  ...
  return (
    <section className="space-y-6">
      <PageHeader
        ...
        description="Clasificación de activos. En el diagrama aprobado las categorías son un catálogo compartido (sin empresa); el resto de catálogos sí se filtra por empresa activa."
        actions={
          puedeEditar ? (
