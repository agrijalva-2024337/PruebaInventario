...
export function activosPorUbicacion(params) {
  return get(apiPaths.reportes.activosPorUbicacion, params);
}

export function diferenciasInventario(params) {
  return get(apiPaths.reportes.diferenciasInventario, params);
}
