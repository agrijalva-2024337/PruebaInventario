...
public sealed class FinalizarMantenimientoCommandHandler : ICommandHandler<FinalizarMantenimientoCommand>
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        _db.HistorialActivos.Add(new HistorialActivo
        {
            ...
            InformacionAnterior = $"id_estado={idEstadoAnterior}; activa=true",
            InformacionNueva = $"id_estado={idEstadoRevertido}; activa=false; fecha_devolucion={entity.FechaDevolucion:o}"
        });
